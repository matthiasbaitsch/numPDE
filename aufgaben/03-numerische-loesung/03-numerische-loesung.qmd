...
Legen Sie ein Jupyter-Notebook für dieses Paket an und laden sie die folgenden Bibliotheken.
...
## Elastisch gelagerter Balken

Ermitteln Sie für den elastische gelagerten Balken aus Aufgabenblatt mit 

$$
  l = \SI{8}{\metre}, \quad q = \SI{50}{\kilo\newton\per\metre} \quad \text{und} \quad k = \SI{500}{\kilo\newton\per\milli\metre}
$$ 

aus Aufgabenblatt 2 eine FE-Lösung. Verwenden Sie ein IPE 300 Profil.
